...
load_dotenv()
os.environ['MONGO_URI'] = 'mongodb://interns:iihmr123@cluster0-shard-00-00.gzuy93a.mongodb.net:27017,cluster0-shard-00-01.gzuy93a.mongodb.net:27017,cluster0-shard-00-02.gzuy93a.mongodb.net:27017/?ssl=true&replicaSet=atlas-<replica-set-name>-shard-0&authSource=admin&retryWrites=true&w=majority'
...
def process_image(image):
    ...
    #made by Manish Katiyar-1BG20AI051,bnmit
...
def work(img):
    ...
    response = requests.post("http://127.0.0.1:5001/predict", json={"file": img_data})
    res = response.json()
...
# Centered content using HTML/CSS
    ...
    if option == 'Upload an image':
        ...
        if img_file_buffer is not None:
            image = Image.open(img_file_buffer)#made by Manish Katiyar-1BG20AI051,bnmit
    if st.button("Submit"):
        if not name:
